...
*Principal Data Scientist*
 ...
 > Complete re-design and implementation of a risk model for cyber catastrophe events for the Cyence product. This model aligns risk of attack more closely to historical experience. Improved computational efficiency from a runtime of 12 hours to 40 minutes using coarse-grained parallelism and vectorized numpy calculations. 
...
*Senior Data Scientist*
 ...
 > Developed machine learning and statistical models to re-design the North American Distribution sales territories. These models optimized coverage for over 200 sales professionals across the country. One direct impact of this analysis was the creation of a new sales territory region in the San Francisco area. 
