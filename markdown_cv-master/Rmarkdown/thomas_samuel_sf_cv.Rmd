...
# github: 'https://github.com/sthomas522/'
...
*Indiana University*, Ph.D. Biostatistics \hfill March 2021
...
*Data Scientist*
 ...
 > Leads a team of 4 consultants to build analytics for three new departments of the North American Client Group. These departments work with the home offices of financial services firms for product placement and sales initiatives. 
 ...
 > Extensive experience with using Salesforce data to drive business decisions related to sales analytics. Worked with senior business leadership to build the foundations for reporting and analytics. 
 
 > Fit a Generalized Linear Mixed Effects model (GLMM) to Salesforce.com data to identify the most significant drivers of work for Internal Wholesalers. 
...
Thomas, S., & Tu, W. (2021). *Learning Hamiltonian Monte Carlo in R*. arXiv preprint arXiv:2006.16194. The American Statistician, doi:10.1080/00031305.2020.1865198
